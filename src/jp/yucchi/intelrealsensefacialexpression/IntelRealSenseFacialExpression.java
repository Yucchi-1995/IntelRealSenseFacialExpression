 ...
 * @author Yucchi
 */
public class IntelRealSenseFacialExpression extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("FacialExpression.fxml"));
        ...
        scene.getStylesheets().add(this.getClass().getResource("FacialExpression.css").toExternalForm());
        stage.setScene(scene);
        Image myIcon = new Image(this.getClass().getResource("resources/sakura_icon.png").toExternalForm());
        stage.getIcons().add(myIcon);
        stage.setTitle("Intel RealSense Facial Expression with JavaFX");
